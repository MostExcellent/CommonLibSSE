...
namespace RE
{
	...
	public:
		...
		// add
		virtual FormID DoGetNumericID() = 0;                                    // 01
		virtual void  DoGetPathingLocation(BSPathingLocation& a_location) = 0;  // 02
		virtual void  DoGetLocation(NiPoint3& a_location) = 0;                  // 03
		virtual void  DoGetEulerAngles(NiPoint3& a_eulerAngles) = 0;            // 04
